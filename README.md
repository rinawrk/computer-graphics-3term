...
## Лабораторная работа №1: настройка Visual Studio + базовый OpenGL 1.0
...
## Лабораторная работа №2: современный OpenGL 4.6, VAO/VBO/EBO + шейдеры
...
- цвет меняется по времени через `glfwGetTime()` + `sin/cos` (uniform)
...
**Цель:** реализовать 3D-сцену с управлением передвижения камеры через WASD и мышь.
